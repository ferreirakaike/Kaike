...
public class WaveSpawner : MonoBehaviour {
	...
	void Start()
	{
		...
		// Hide final score and display current score
	...
	void WaveCompleted()
	{
		...
		{
			Mivry mivry = cameraRig.GetComponent<Mivry>();
			mivry.StopScript();
			castingHand.SetActive(false);
			saber.gameObject.SetActive(true);
			finalBoss.gameObject.SetActive(true);
			this.gameObject.SetActive(false);
			Debug.Log("ALL WAVES COMPLETE! Looping...");

			// Hide current score and display final score
